...
_Try [remoteproc-runtime-example-lightbulb](https://github.com/arm/remoteproc-runtime-example-lightbulb) for a full stack Remoteproc message Zephyr RTOS application, and web app that can be deployed using Remoteproc Runtime._
