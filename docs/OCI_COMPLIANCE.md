...
| [Filesystem and Mounts](#7-filesystem-and-mounts) | 🟡 Minimal | Firmware extraction only |
| [Process Management and I/O](#8-process-management-and-io) | 🟡 Minimal | Single arg (firmware name), no stdio |
